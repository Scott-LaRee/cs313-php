 ...
 <div id="content">
  <div>
   ...
   <?php
     try
	 {
	   $statement = $db->prepare('Select id, meeting_date FROM meetings');
	   $statement->execute();
   ...
   ?>
   <!--
   <form name="view_meeting" action="viewMeeting.php" method="POST">
   ...
   <select name="year_view" id="year_view">
   ...
   <label for="title">Meeting Type</label>
